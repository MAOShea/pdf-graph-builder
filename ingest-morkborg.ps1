# ingest-morkborg.ps1 - Mork Borg PDF ingest wrapper around ingest-pdf.ps1.
...
#   .\ingest-morkborg.ps1 -ScaffoldDiffLlm
#   .\ingest-morkborg.ps1 -ScaffoldDiffEmbed
...
# ScaffoldDiffLlm: opt in to Ollama Stage 2 CONFIRMS_SEED / flags. Default off.
# ScaffoldDiffEmbed: opt in to Chunk.embedding MiniLM. Default off. Does not skip page TokenTextSplitter.
...
if ($ScaffoldDiffLlm) { $invokeArgs.ScaffoldDiffLlm = $true }
if ($ScaffoldDiffEmbed) { $invokeArgs.ScaffoldDiffEmbed = $true }
