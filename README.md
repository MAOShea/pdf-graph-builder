...
See `games/mork-borg/README.md` (passage-sections schema + contracts), `games/mork-borg/hand-authored-overrides/README.md`, and `docs/roadmap.md` for the Mörk Borg contract and ingest backlog.
