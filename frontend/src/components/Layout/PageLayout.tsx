        ...
        if (connectionData.data && connectionData.status === 'Success') {
          ...
          setConnectionStatus(
            Array.isArray(connectionData.data.graph_connection)
              ? connectionData.data.graph_connection[0] === 'True'
              : connectionData.data.graph_connection === true || connectionData.data.graph_connection === 'True'
          );
  ...
  return (
    <>
      {!isAuthenticated && !SKIP_AUTH && isFirstTimeUser ? (
        ...
        />
      ) : (isAuthenticated || SKIP_AUTH) && isFirstTimeUser && !SKIP_AUTH ? (
        <SpotlightTour
